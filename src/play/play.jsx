      ...
      <div className="game">
        <div className="game-table">
          <div className="left-players">
            <div className="player-info" id="player2">
              <span className="player-name"></span>
              <span className="cards-in-hand"></span>
            </div>
          </div>
          <div className="game-column">
            <div className="top-players">
              <div className="player-info" id="player3">
                <span className="player-name"></span>
                <span className="cards-in-hand"></span>
              </div>
            </div>
            ...
            <div className="game-info">
              <div className="info">
                <span>Currently Playing:</span>
                  <span id="currPlayer"></span>
                    <span># Cards in Pile:</span>
                    <span id="num-cards-in-pile"></span>
                      <span>Current Card: </span>
                      <span id="currCard"></span>
                        <span>Previous Discard:</span>
          ...
          <div className="right-players">
            <div className="player-info" id="player4">
              <span className="player-name"></span>
              <span className="cards-in-hand"></span>
            </div>
          </div>
        ...
        <div className="BS">
          <button className="btn btn-light btn-outline-danger" id="bsBtn">
            BS!!!
          </button>
        </div>
        <div className="Play">
          <button className="btn btn-light btn-outline-success" id="playBtn">
            Play
          </button>
        </div>
        <br/>
        ...
        <div className="player">
          ...
          <br/>
            <br/>
              <div className="player-info" id="player1">
                <span className="player-name"></span>
                <span className="cards-in-hand"></span>
              </div>
        </div>
        ...
        <br/>
        <br/>
        <Button className="btn btn-danger btn-outline-light" onClick={() => navigate('/lobby')}>Leave Game</Button>
        <br/>
        <br/>
        <br/>
        <br/>
